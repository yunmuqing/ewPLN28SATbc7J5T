...
$(document).ready(function() {
    ...
    $('#defaultForm input[type="radio"]').on('change',function(){
        do_change();
    });
    function do_change(){
        var style = ':root{';
        ...
        ajaxData[$('#defaultForm input[type="radio"]:checked').attr('name')] = $('#defaultForm input[type="radio"]:checked').val();
        style += `${$('#defaultForm input[type="radio"]:checked').attr('name')}: ${$('#defaultForm input[type="radio"]:checked').val()};`;
    ...
    $(".color-save").on('click',function () {
        ...
        if (!$(this).hasClass('disabled')){
            ...
            $.ymqajax({
                url: " /api/branding/discount.html",
                data: ajaxData,
